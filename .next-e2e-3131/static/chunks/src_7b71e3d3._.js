...
"[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$tabler$2b$icons$2d$react$40$3$2e$35$2e$0_react$40$19$2e$2$2e$1$2f$node_modules$2f40$tabler$2f$icons$2d$react$2f$dist$2f$esm$2f$icons$2f$IconPhoneCall$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__IconPhoneCall$3e$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/@tabler+icons-react@3.35.0_react@19.2.1/node_modules/@tabler/icons-react/dist/esm/icons/IconPhoneCall.mjs [app-client] (ecmascript) <export default as IconPhoneCall>");
...
const safeTimelineValue = (value)=>{
    ...
    if (Array.isArray(value)) {
        return value.length ? "".concat(value.length, " evidence item").concat(value.length === 1 ? "" : "s") : "Not provided yet";
    }
...
const buildStructuredTimelineEntries = function(backendFields) {
    let localFields = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    return timelineFieldConfig.map((field)=>{
...
const buildStatusHistoryEntries = (timeline)=>timeline.reduce((entries, item, index)=>{
        ...
        var _item__id;
        const entry = {
            id: String((_item__id = item._id) !== null && _item__id !== void 0 ? _item__id : "".concat(status, "-").concat(index)),
            status
        };
...
const stringifyPreviewPayload = (payload)=>JSON.stringify(payload, null, 2);
const formatConsentFlag = (flag)=>flag.replace(/_/g, " ");
const formatConsentFlags = (flags)=>flags.map(formatConsentFlag).join(", ");
const areStructuredFieldsEqual = (left, right)=>JSON.stringify(left) === JSON.stringify(right);
const toTelHref = (phone)=>{
    const normalized = phone.replace(/[^\d+]/g, "");
    return normalized ? "tel:".concat(normalized) : "tel:".concat(phone);
};
const toMailHref = (email, destinationName)=>{
    const subject = encodeURIComponent("SafeSpeak contact request for ".concat(destinationName));
    return "mailto:".concat(email, "?subject=").concat(subject);
};
const inferIncidentTypeFromStructuredFields = (structuredFields)=>{
    const narrative = Object.values(structuredFields).filter((value)=>typeof value === "string").join(" ").toLowerCase();
    ...
    return domesticViolenceTerms.some((term)=>narrative.includes(term)) ? "domestic_violence" : undefined;
};
...
function ReportSubmissionReviewPage() {
    ...
    const reportDraft = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ReportSubmissionReviewPage.useMemo[reportDraft]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$report$2d$flow$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getResolvedReportFlowDraft"])()
    }["ReportSubmissionReviewPage.useMemo[reportDraft]"], []);
    const fallbackCreatePromiseRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const [timelineEntries, setTimelineEntries] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [backendStructuredFields, setBackendStructuredFields] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    var _reportDraft_structuredFields;
    const [currentStructuredFields, setCurrentStructuredFields] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])((_reportDraft_structuredFields = reportDraft === null || reportDraft === void 0 ? void 0 : reportDraft.structuredFields) !== null && _reportDraft_structuredFields !== void 0 ? _reportDraft_structuredFields : {});
    const [reportLanguage, setReportLanguage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("en");
    const [reportJurisdiction, setReportJurisdiction] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("NSW");
    ...
    const [selectedDestinationIds, setSelectedDestinationIds] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])((reportDraft === null || reportDraft === void 0 ? void 0 : reportDraft.selectedDestinationId) ? [
        reportDraft.selectedDestinationId
    ] : []);
    const [submissionPreviews, setSubmissionPreviews] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [anonymityMode, setAnonymityMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("identified");
    const [submissionNotes, setSubmissionNotes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [statusHistoryEntries, setStatusHistoryEntries] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(Boolean(reportDraft === null || reportDraft === void 0 ? void 0 : reportDraft.reportId));
    const [isLoadingSubmissionPreviews, setIsLoadingSubmissionPreviews] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [timelineStatusMessage, setTimelineStatusMessage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [expandedEntryId, setExpandedEntryId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [isManualEntryOpen, setIsManualEntryOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [manualEntryType, setManualEntryType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("What");
    const [manualEntryValue, setManualEntryValue] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [isSavingTimeline, setIsSavingTimeline] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [editingEntryValue, setEditingEntryValue] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ReportSubmissionReviewPage.useEffect": ()=>{
            const reportId = reportDraft === null || reportDraft === void 0 ? void 0 : reportDraft.reportId;
            if (!reportId) {
                if (reportDraft === null || reportDraft === void 0 ? void 0 : reportDraft.structuredFields) {
                    var _localEntries_;
                    ...
                    var _localEntries__id;
                    setExpandedEntryId((_localEntries__id = (_localEntries_ = localEntries[0]) === null || _localEntries_ === void 0 ? void 0 : _localEntries_.id) !== null && _localEntries__id !== void 0 ? _localEntries__id : null);
                    setIsLoading(false);
                    let isActive = true;
                    void ({
                        "ReportSubmissionReviewPage.useEffect": async ()=>{
                            try {
                                var _destinationOptions_, _backendEntries_;
                                const latestResolvedDraft = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$report$2d$flow$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getResolvedReportFlowDraft"])();
                                if (latestResolvedDraft === null || latestResolvedDraft === void 0 ? void 0 : latestResolvedDraft.reportId) {
                                    var _destinationOptions_1, _backendEntries_1;
                                    const [report, timeline, destinationOptions] = await Promise.all([
                                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$reports$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getReport"])(latestResolvedDraft.reportId),
                                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$reports$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getReportTimeline"])(latestResolvedDraft.reportId),
                                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$reports$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getReportDestinations"])(latestResolvedDraft.reportId)
                                    ]);
                                    if (!isActive) {
                                        return;
                                    }
                                    var _report_structuredFields, _ref, _ref1;
                                    const resolvedStructuredFields = (_ref1 = (_ref = (_report_structuredFields = report.structuredFields) !== null && _report_structuredFields !== void 0 ? _report_structuredFields : latestResolvedDraft.structuredFields) !== null && _ref !== void 0 ? _ref : reportDraft.structuredFields) !== null && _ref1 !== void 0 ? _ref1 : {};
                                    const backendEntries = buildStructuredTimelineEntries(resolvedStructuredFields, resolvedStructuredFields);
                                    var _latestResolvedDraft_selectedDestinationId;
                                    const resolvedDestinationId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$report$2d$authority$2d$routing$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolvePreferredDestinationId"])(destinationOptions, (_latestResolvedDraft_selectedDestinationId = latestResolvedDraft.selectedDestinationId) !== null && _latestResolvedDraft_selectedDestinationId !== void 0 ? _latestResolvedDraft_selectedDestinationId : reportDraft.selectedDestinationId);
                                    const fallbackDestinationId = resolvedDestinationId !== null && resolvedDestinationId !== void 0 ? resolvedDestinationId : (_destinationOptions_1 = destinationOptions[0]) === null || _destinationOptions_1 === void 0 ? void 0 : _destinationOptions_1.destinationId;
                                    ...
                                    var _backendEntries__id;
                                    setExpandedEntryId((_backendEntries__id = (_backendEntries_1 = backendEntries[0]) === null || _backendEntries_1 === void 0 ? void 0 : _backendEntries_1.id) !== null && _backendEntries__id !== void 0 ? _backendEntries__id : null);
                                    setStatusHistoryEntries(buildStatusHistoryEntries(timeline));
                                    var _report_language;
                                    setReportLanguage((_report_language = report.language) !== null && _report_language !== void 0 ? _report_language : "en");
                                    var _report_jurisdiction;
                                    setReportJurisdiction((_report_jurisdiction = report.jurisdiction) !== null && _report_jurisdiction !== void 0 ? _report_jurisdiction : "NSW");
                                    setDestinations(destinationOptions);
                                    setSelectedDestinationId(fallbackDestinationId !== null && fallbackDestinationId !== void 0 ? fallbackDestinationId : null);
                                    setSelectedDestinationIds(fallbackDestinationId ? [
                                        fallbackDestinationId
                                    ] : []);
                                    setLoadError(null);
                                    var _report_incidentType, _ref2;
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$report$2d$flow$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeReportFlowDraft"])({
                                        ...
                                        incidentType: (_ref2 = (_report_incidentType = report.incidentType) !== null && _report_incidentType !== void 0 ? _report_incidentType : latestResolvedDraft.incidentType) !== null && _ref2 !== void 0 ? _ref2 : reportDraft.incidentType
                                    });
                                    return;
                                }
                                if (!fallbackCreatePromiseRef.current) {
                                    fallbackCreatePromiseRef.current = ({
                                        "ReportSubmissionReviewPage.useEffect": async ()=>{
                                            var _reportDraft_structuredFields;
                                            var _reportDraft_incidentType, _reportDraft_structuredFields1, _ref;
                                            const incidentType = (_ref = (_reportDraft_incidentType = reportDraft.incidentType) !== null && _reportDraft_incidentType !== void 0 ? _reportDraft_incidentType : reportDraft.incidentCategory) !== null && _ref !== void 0 ? _ref : inferIncidentTypeFromStructuredFields((_reportDraft_structuredFields1 = reportDraft.structuredFields) !== null && _reportDraft_structuredFields1 !== void 0 ? _reportDraft_structuredFields1 : {});
                                            var _reportDraft_structuredFields_what;
                                            const savedReport = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$reports$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createReport"])({
                                                language: "en",
                                                jurisdiction: "NSW",
                                                context: reportDraft.title || "SafeSpeak incident report",
                                                originalNarrative: reportDraft.summary || String((_reportDraft_structuredFields_what = (_reportDraft_structuredFields = reportDraft.structuredFields) === null || _reportDraft_structuredFields === void 0 ? void 0 : _reportDraft_structuredFields.what) !== null && _reportDraft_structuredFields_what !== void 0 ? _reportDraft_structuredFields_what : ""),
                                                incidentType,
                                                structuredFields: reportDraft.structuredFields,
                                                status: "draft"
                                            });
                                            const destinationOptions = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$reports$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getReportDestinations"])(savedReport._id);
                                            return {
                                                savedReport,
                                                destinationOptions,
                                                incidentType
                                    ...
                                    })["ReportSubmissionReviewPage.useEffect"]().catch({
                                        "ReportSubmissionReviewPage.useEffect": (error)=>{
                                            fallbackCreatePromiseRef.current = null;
                                            throw error;
                                        }
                                    }["ReportSubmissionReviewPage.useEffect"]);
                                }
                                const { savedReport, destinationOptions, incidentType } = await fallbackCreatePromiseRef.current;
                                if (!isActive) {
                                    return;
                                }
                                var _savedReport_structuredFields, _ref3;
                                const resolvedStructuredFields = (_ref3 = (_savedReport_structuredFields = savedReport.structuredFields) !== null && _savedReport_structuredFields !== void 0 ? _savedReport_structuredFields : reportDraft.structuredFields) !== null && _ref3 !== void 0 ? _ref3 : {};
                                const backendEntries = buildStructuredTimelineEntries(resolvedStructuredFields, resolvedStructuredFields);
                                const resolvedDestinationId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$report$2d$authority$2d$routing$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolvePreferredDestinationId"])(destinationOptions, reportDraft.selectedDestinationId);
                                const fallbackDestinationId = resolvedDestinationId !== null && resolvedDestinationId !== void 0 ? resolvedDestinationId : (_destinationOptions_ = destinationOptions[0]) === null || _destinationOptions_ === void 0 ? void 0 : _destinationOptions_.destinationId;
                                setBackendStructuredFields(resolvedStructuredFields);
                                setCurrentStructuredFields(resolvedStructuredFields);
                                setTimelineEntries(backendEntries);
                                var _backendEntries__id1;
                                setExpandedEntryId((_backendEntries__id1 = (_backendEntries_ = backendEntries[0]) === null || _backendEntries_ === void 0 ? void 0 : _backendEntries_.id) !== null && _backendEntries__id1 !== void 0 ? _backendEntries__id1 : null);
                                setDestinations(destinationOptions);
                                setSelectedDestinationId(fallbackDestinationId !== null && fallbackDestinationId !== void 0 ? fallbackDestinationId : null);
                                setSelectedDestinationIds(fallbackDestinationId ? [
                                    fallbackDestinationId
                                ...
                                setLoadError(null);
                                var _savedReport_incidentType;
                                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$report$2d$flow$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeReportFlowDraft"])({
                                    reportId: savedReport._id,
                                    selectedDestinationId: fallbackDestinationId,
                                    structuredFields: resolvedStructuredFields,
                                    incidentType: (_savedReport_incidentType = savedReport.incidentType) !== null && _savedReport_incidentType !== void 0 ? _savedReport_incidentType : incidentType
                                });
                            } catch (error) {
                                if (!isActive) {
                                    return;
                                }
                                setLoadError(error instanceof Error ? error.message : "SafeSpeak could not create a backend report for contact options.");
                            }
                        }
                    })["ReportSubmissionReviewPage.useEffect"]();
                    return ({
            ...
            void ({
                "ReportSubmissionReviewPage.useEffect": async ()=>{
                    try {
                        var _backendEntries_, _destinationOptions_;
                        const [report, status, timeline] = await Promise.all([
                            ...
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$reports$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getReportStatus"])(reportId),
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$reports$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getReportTimeline"])(reportId)
                        ]);
                        if (!isActive) {
                            return;
                        }
                        var _reportDraft_structuredFields, _report_structuredFields;
                        const mergedStructuredFields = {
                            ...
                            ...(_report_structuredFields = report.structuredFields) !== null && _report_structuredFields !== void 0 ? _report_structuredFields : {}
                        };
                        var _report_structuredFields1;
                        const backendStructuredFields = (_report_structuredFields1 = report.structuredFields) !== null && _report_structuredFields1 !== void 0 ? _report_structuredFields1 : {};
                        var _reportDraft_incidentType, _ref, _ref1;
                        const resolvedIncidentType = (_ref1 = (_ref = (_reportDraft_incidentType = reportDraft === null || reportDraft === void 0 ? void 0 : reportDraft.incidentType) !== null && _reportDraft_incidentType !== void 0 ? _reportDraft_incidentType : reportDraft === null || reportDraft === void 0 ? void 0 : reportDraft.incidentCategory) !== null && _ref !== void 0 ? _ref : inferIncidentTypeFromStructuredFields(mergedStructuredFields)) !== null && _ref1 !== void 0 ? _ref1 : report.incidentType;
                        const requiresBackendSync = report._id && (Object.keys(mergedStructuredFields).length > 0 && !areStructuredFieldsEqual(backendStructuredFields, mergedStructuredFields) || resolvedIncidentType && resolvedIncidentType !== report.incidentType);
                        const syncedReport = requiresBackendSync ? await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$reports$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateReport"])(report._id, {
                        ...
                        const destinationOptions = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$reports$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getReportDestinations"])(syncedReport._id);
                        var _syncedReport_structuredFields;
                        const resolvedStructuredFields = (_syncedReport_structuredFields = syncedReport.structuredFields) !== null && _syncedReport_structuredFields !== void 0 ? _syncedReport_structuredFields : mergedStructuredFields;
                        const resolvedDestinationId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$report$2d$authority$2d$routing$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolvePreferredDestinationId"])(destinationOptions, reportDraft === null || reportDraft === void 0 ? void 0 : reportDraft.selectedDestinationId);
                        setBackendStructuredFields(resolvedStructuredFields);
                        setCurrentStructuredFields(resolvedStructuredFields);
                        const backendEntries = buildStructuredTimelineEntries(resolvedStructuredFields, resolvedStructuredFields);
                        setTimelineEntries(backendEntries);
                        var _backendEntries__id;
                        setExpandedEntryId((_backendEntries__id = (_backendEntries_ = backendEntries[0]) === null || _backendEntries_ === void 0 ? void 0 : _backendEntries_.id) !== null && _backendEntries__id !== void 0 ? _backendEntries__id : null);
                        setStatusHistoryEntries(buildStatusHistoryEntries(timeline));
                        var _syncedReport_language;
                        setReportLanguage((_syncedReport_language = syncedReport.language) !== null && _syncedReport_language !== void 0 ? _syncedReport_language : "en");
                        var _syncedReport_jurisdiction;
                        setReportJurisdiction((_syncedReport_jurisdiction = syncedReport.jurisdiction) !== null && _syncedReport_jurisdiction !== void 0 ? _syncedReport_jurisdiction : "NSW");
                        setDestinations(destinationOptions);
                        setSelectedDestinationId({
                            "ReportSubmissionReviewPage.useEffect": (currentDestinationId)=>{
                                var _destinationOptions_;
                                const resolvedCurrentDestinationId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$report$2d$authority$2d$routing$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolvePreferredDestinationId"])(destinationOptions, currentDestinationId !== null && currentDestinationId !== void 0 ? currentDestinationId : undefined);
                                if (resolvedCurrentDestinationId && destinationOptions.some({
                                    "ReportSubmissionReviewPage.useEffect": (destination)=>destination.destinationId === resolvedCurrentDestinationId
                                }["ReportSubmissionReviewPage.useEffect"])) {
                                    return resolvedCurrentDestinationId;
                                }
                                var _destinationOptions__destinationId;
                                const preferredDestinationId = resolvedDestinationId && destinationOptions.some({
                                    "ReportSubmissionReviewPage.useEffect": (destination)=>destination.destinationId === resolvedDestinationId
                                }["ReportSubmissionReviewPage.useEffect"]) ? resolvedDestinationId : (_destinationOptions__destinationId = (_destinationOptions_ = destinationOptions[0]) === null || _destinationOptions_ === void 0 ? void 0 : _destinationOptions_.destinationId) !== null && _destinationOptions__destinationId !== void 0 ? _destinationOptions__destinationId : null;
                                return preferredDestinationId;
                            }
                        }["ReportSubmissionReviewPage.useEffect"]);
                        setSelectedDestinationIds({
                            "ReportSubmissionReviewPage.useEffect": (currentDestinationIds)=>{
                                var _destinationOptions_;
                                const validDestinationIds = currentDestinationIds.map({
                                    "ReportSubmissionReviewPage.useEffect.validDestinationIds": (destinationId)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$report$2d$authority$2d$routing$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolvePreferredDestinationId"])(destinationOptions, destinationId)
                                }["ReportSubmissionReviewPage.useEffect.validDestinationIds"]).filter({
                                    "ReportSubmissionReviewPage.useEffect.validDestinationIds": (destinationId)=>destinationOptions.some({
                                            "ReportSubmissionReviewPage.useEffect.validDestinationIds": (destination)=>destination.destinationId === destinationId
                                        }["ReportSubmissionReviewPage.useEffect.validDestinationIds"])
                                }["ReportSubmissionReviewPage.useEffect.validDestinationIds"]);
                                if (validDestinationIds.length) {
                                    return validDestinationIds;
                                }
                                const fallbackDestinationId = resolvedDestinationId && destinationOptions.some({
                                    "ReportSubmissionReviewPage.useEffect": (destination)=>destination.destinationId === resolvedDestinationId
                                }["ReportSubmissionReviewPage.useEffect"]) ? resolvedDestinationId : (_destinationOptions_ = destinationOptions[0]) === null || _destinationOptions_ === void 0 ? void 0 : _destinationOptions_.destinationId;
                        ...
                        setLoadError(null);
                        var _syncedReport_incidentType;
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$report$2d$flow$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeReportFlowDraft"])({
                            reportId: syncedReport._id,
                            selectedDestinationId: resolvedDestinationId !== null && resolvedDestinationId !== void 0 ? resolvedDestinationId : (_destinationOptions_ = destinationOptions[0]) === null || _destinationOptions_ === void 0 ? void 0 : _destinationOptions_.destinationId,
                            structuredFields: resolvedStructuredFields,
                            incidentType: (_syncedReport_incidentType = syncedReport.incidentType) !== null && _syncedReport_incidentType !== void 0 ? _syncedReport_incidentType : resolvedIncidentType
                        });
                    } catch (error) {
                        if (!isActive) {
                            return;
                        ...
                        setLoadError(error instanceof Error ? error.message : "SafeSpeak could not load this report review from the backend.");
                    } finally{
                        if (isActive) {
                            setIsLoading(false);
                        }
        ...
        reportDraft === null || reportDraft === void 0 ? void 0 : reportDraft.structuredFields
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ReportSubmissionReviewPage.useEffect": ()=>{
            const reportId = reportDraft === null || reportDraft === void 0 ? void 0 : reportDraft.reportId;
            ...
            void (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$reports$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["previewReportSubmissions"])(reportId, {
                destinationIds: selectedDestinationIds,
                anonymityMode,
                notes: submissionNotes.trim() || undefined
            }).then({
                "ReportSubmissionReviewPage.useEffect": (previews)=>{
                    if (isActive) {
                ...
                "ReportSubmissionReviewPage.useEffect": (error)=>{
                    if (isActive) {
                        setLoadError(error instanceof Error ? error.message : "Submission previews could not be generated.");
                    }
                }
            }["ReportSubmissionReviewPage.useEffect"]).finally({
                "ReportSubmissionReviewPage.useEffect": ()=>{
                    if (isActive) {
    ...
    const toggleEntry = (entryId)=>{
        setExpandedEntryId((currentEntryId)=>currentEntryId === entryId ? null : entryId);
    };
    ...
    const buildDraftFieldPatch = (fieldKey, value)=>({
            ...fieldKey === "what" ? {
                summary: value !== null && value !== void 0 ? value : ""
            } : {},
            ...fieldKey === "when" ? {
                date: value !== null && value !== void 0 ? value : ""
            } : {},
            ...fieldKey === "where" ? {
                location: value !== null && value !== void 0 ? value : ""
            } : {}
        });
    const syncTimelineField = async (fieldKey, value)=>{
        ...
        setTimelineEntries(buildStructuredTimelineEntries(backendStructuredFields, nextStructuredFields));
        ...
        try {
            const savedReport = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$reports$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateReport"])(reportDraft.reportId, {
                structuredFields: nextStructuredFields,
                ...fieldKey === "what" ? {
                    originalNarrative: trimmedValue !== null && trimmedValue !== void 0 ? trimmedValue : ""
                } : {}
            });
            var _savedReport_structuredFields;
            const savedStructuredFields = (_savedReport_structuredFields = savedReport.structuredFields) !== null && _savedReport_structuredFields !== void 0 ? _savedReport_structuredFields : nextStructuredFields;
            setBackendStructuredFields(savedStructuredFields);
            setCurrentStructuredFields(savedStructuredFields);
            setTimelineEntries(buildStructuredTimelineEntries(savedStructuredFields, savedStructuredFields));
            setTimelineStatusMessage(trimmedValue ? "Timeline saved to SafeSpeak." : "Timeline field removed from SafeSpeak.");
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$report$2d$flow$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeReportFlowDraft"])({
                reportId: savedReport._id,
            ...
            setLoadError(error instanceof Error ? error.message : "Timeline changes could not be synced to SafeSpeak.");
            setTimelineStatusMessage("Timeline saved in this browser only. Backend sync did not complete.");
        } finally{
    ...
    const startEditingEntry = (entry)=>{
        ...
        setEditingEntryValue(typeof currentStructuredFields[entry.id] === "string" ? String(currentStructuredFields[entry.id]) : entry.value === "Not provided yet" ? "" : entry.value);
    };
    const handleInlineEditSubmit = async (event, entryId)=>{
        event.preventDefault();
        await syncTimelineField(entryId, editingEntryValue);
        closeInlineEditor();
    };
    const handleRemoveEntry = async (entryId)=>{
        await syncTimelineField(entryId);
        closeInlineEditor();
    };
    const toggleDestinationSelection = (destinationId)=>{
        setSelectedDestinationIds((currentDestinationIds)=>{
            if (currentDestinationIds.includes(destinationId)) {
                ...
                if (selectedDestinationId === destinationId) {
                    var _nextDestinationIds_;
                    setSelectedDestinationId((_nextDestinationIds_ = nextDestinationIds[0]) !== null && _nextDestinationIds_ !== void 0 ? _nextDestinationIds_ : null);
                }
    ...
    var _destinations_find;
    const selectedDestination = (_destinations_find = destinations.find((destination)=>destination.destinationId === selectedDestinationId)) !== null && _destinations_find !== void 0 ? _destinations_find : null;
    const mockDestinations = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$report$2d$submission$2d$mock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["REPORT_SUBMISSION_MOCK_MODE"] ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$report$2d$submission$2d$mock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMockDestinations"])(reportDraft) : [];
    var _ref, _ref1;
    const fallbackDestination = (_ref1 = (_ref = selectedDestination !== null && selectedDestination !== void 0 ? selectedDestination : destinations[0]) !== null && _ref !== void 0 ? _ref : mockDestinations[0]) !== null && _ref1 !== void 0 ? _ref1 : null;
        ...
        if (destination) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$report$2d$flow$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeReportFlowDraft"])({
                ...
                preparedSubmission: {
                    ...
                    missingRequiredInfo: destination.missingRequiredInfo,
                    reason: destination.reason,
                    message: destination.missingRequiredInfo.length > 0 ? "Review the missing details before final sharing." : "Recipient reviewed. Continue to confirm and send.",
                    updatedAt: new Date().toISOString()
                }
            });
        } else {
    ...
    var _fallbackDestination_destinationId, _ref2;
    const shareHref = withTriageParam((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$report$2d$flow$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildReportFlowHref"])("reportsubmissionshare", {
        reportId: reportDraft === null || reportDraft === void 0 ? void 0 : reportDraft.reportId,
        selectedDestinationId: (_ref2 = (_fallbackDestination_destinationId = fallbackDestination === null || fallbackDestination === void 0 ? void 0 : fallbackDestination.destinationId) !== null && _fallbackDestination_destinationId !== void 0 ? _fallbackDestination_destinationId : selectedDestinationId) !== null && _ref2 !== void 0 ? _ref2 : reportDraft === null || reportDraft === void 0 ? void 0 : reportDraft.selectedDestinationId
    }), fromTriage);
    const canContinueToShare = Boolean(fallbackDestination) && !loadError && !isLoading;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dashboard$2f$dashboard$2d$report$2d$submission$2d$pages$2f$report$2d$submission$2d$frame$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ReportSubmissionFrame"], {
        ...
        backHref: fromTriage ? "/dashboard?view=reportsubmissionevidence&fromTriage=1" : "/dashboard?view=reportsubmissionevidence",
        backLabel: "Details",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "mt-4",
            children: [
                loadError ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "mb-4 rounded-[12px] border border-[#fde2e2] bg-[#fff5f5] px-3 py-2 text-[11px] text-[#b45353]",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$tabler$2b$icons$2d$react$40$3$2e$35$2e$0_react$40$19$2e$2$2e$1$2f$node_modules$2f40$tabler$2f$icons$2d$react$2f$dist$2f$esm$2f$icons$2f$IconAlertCircle$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__IconAlertCircle$3e$__["IconAlertCircle"], {
                                ...
                                fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                                lineNumber: 931,
                                columnNumber: 19
                            }, this),
                            loadError
                ...
                timelineStatusMessage ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "mb-4 rounded-[12px] border border-[#d8e4f2] bg-white px-3 py-2 text-[11px] font-medium text-[#0f5d9f]",
                    children: timelineStatusMessage
                }, void 0, false, {
                    fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                    lineNumber: 937,
                    columnNumber: 15
                }, this) : null,
                statusHistoryEntries.length ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "mb-4 rounded-[12px] border border-[#dce5f1] bg-white px-4 py-3",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: statusHistoryEntries.map((entry)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: [
                                        ...
                                        entry.reason ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            children: [
                                                " - ",
                                                entry.reason
                                            ]
                                        ...
                                        entry.changedAt ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            children: [
                                                " ",
                                                "- ",
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "mt-1 text-[12px] text-[#60728a]",
                                            children: [
                                                "Language `",
                                                reportLanguage,
                                                "` in `",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-[10px] text-[#8ea0b8]",
                                    children: [
                                        destinations.length,
                                        " option",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: destinations.length ? destinations.map((destination)=>{
                                const isSelected = destination.destinationId === selectedDestinationId;
                                const isIncluded = selectedDestinationIds.includes(destination.destinationId);
                                const hasMissingInfo = destination.missingRequiredInfo.length > 0;
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    type: "button",
                                    onClick: ()=>toggleDestinationSelection(destination.destinationId),
                                    className: "w-full rounded-[12px] border px-4 py-3 text-left transition ".concat(isSelected ? "border-[#0f52ba] bg-[#f7fbff]" : "border-[#dce5f1] bg-white"),
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex flex-wrap items-center justify-between gap-2",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    className: "inline-flex h-4 w-4 items-center justify-center rounded border ".concat(isIncluded ? "border-[#0f52ba] bg-[#0f52ba]" : "border-[#cbd8e8] bg-white"),
                                                                    children: isIncluded ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                            className: "mt-1 text-[10px] text-[#6d8199]",
                                                            children: [
                                                        ...
                                                        destination.contactPhone || destination.contactEmail ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                            className: "mt-1 text-[10px] text-[#6d8199]",
                                                            children: [
                                                                "Contact listed:",
                                                                " ",
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "rounded-full px-2 py-1 text-[9px] font-bold uppercase tracking-[0.08em] ".concat(hasMissingInfo ? "bg-[#fff2df] text-[#9a6a2e]" : "bg-[#e9f7ef] text-[#0b8b54]"),
                                                    children: hasMissingInfo ? "".concat(destination.missingRequiredInfo.length, " fields missing") : "Ready"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                                                    lineNumber: 1041,
                                                    columnNumber: 27
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "mt-2 text-[10px] leading-[1.55] text-[#60728a]",
                                            children: [
                                                "Why: ",
                                                destination.reason
                                            ]
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "mt-1 text-[10px] leading-[1.55] text-[#60728a]",
                                            children: [
                                                "Required:",
                                                " ",
                                                destination.minimumRequiredInfo.join(", ") || "None listed"
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                                            lineNumber: 1056,
                                        ...
                                        destination.expectedNextSteps.length ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "mt-1 text-[10px] leading-[1.55] text-[#60728a]",
                                            children: [
                                                "Next: ",
                                                destination.expectedNextSteps.join(" / ")
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                                            lineNumber: 1062,
                                ...
                                }, destination.destinationId, true, {
                                    fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                                    lineNumber: 994,
                                    columnNumber: 23
                                }, this);
                            }) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "rounded-[12px] border border-[#f2d8b0] bg-[#fffaf2] px-3 py-2 text-[11px] text-[#9a5b12]",
                                children: "No active destinations match this report yet. Add or activate them in the admin dashboard."
                            }, void 0, false, {
                                fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                                lineNumber: 1070,
                                columnNumber: 19
                        ...
                        selectedDestination ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "mt-3 grid gap-3 rounded-[12px] border border-[#edf2f8] bg-[#f9fbfe] p-3 sm:grid-cols-2",
                            children: [
                                ...
                                selectedDestination.contactPhone || selectedDestination.contactEmail ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "rounded-[10px] border border-[#dce5f1] bg-white px-3 py-3 sm:col-span-2",
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex flex-wrap items-center justify-between gap-2",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        className: "mt-1 text-[10px] leading-[1.55] text-[#60728a]",
                                                        children: "These buttons open your phone or email app only when you choose them."
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                                                        lineNumber: 1120,
                                                        columnNumber: 27
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    selectedDestination.contactPhone ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$tabler$2b$icons$2d$react$40$3$2e$35$2e$0_react$40$19$2e$2$2e$1$2f$node_modules$2f40$tabler$2f$icons$2d$react$2f$dist$2f$esm$2f$icons$2f$IconPhoneCall$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__IconPhoneCall$3e$__["IconPhoneCall"], {
                                                                size: 12
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                                                                lineNumber: 1131,
                                                    ...
                                                    selectedDestination.contactEmail ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                                        href: toMailHref(selectedDestination.contactEmail, selectedDestination.destinationName),
                                                        className: "inline-flex h-9 items-center gap-1.5 rounded-[8px] border border-[#cfdceb] bg-[#f8fbff] px-3 text-[10px] font-bold text-[#244961]",
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$tabler$2b$icons$2d$react$40$3$2e$35$2e$0_react$40$19$2e$2$2e$1$2f$node_modules$2f40$tabler$2f$icons$2d$react$2f$dist$2f$esm$2f$icons$2f$IconMail$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__IconMail$3e$__["IconMail"], {
                                                                size: 12
                                ...
                                selectedDestination.requiredConsentFlags.length ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "rounded-[10px] border border-[#dce5f1] bg-white px-3 py-2 text-[10px] leading-[1.55] text-[#60728a] sm:col-span-2",
                                    children: [
                                        "Consent required before SafeSpeak shares reviewed information:",
                                        " ",
                        ...
                        selectedDestinationIds.length ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "mt-3 rounded-[12px] border border-[#edf2f8] bg-white p-3",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "flex flex-wrap items-center justify-between gap-2",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-[10px] font-bold uppercase tracking-[0.08em] text-[#7c8da3]",
                                            children: "Recipient payload previews"
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                                            lineNumber: 1170,
                                            columnNumber: 21
                                ...
                                isLoadingSubmissionPreviews ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "mt-3 inline-flex items-center gap-2 text-[10px] text-[#60728a]",
                                    children: [
                                    ...
                                    children: submissionPreviews.map((preview)=>{
                                        var _preview_template_templateName;
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                    ...
                                                                    children: preview.destination.destinationName
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                                                                    lineNumber: 1191,
                                                                    columnNumber: 31
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                    ...
                                                                    children: [
                                                                        "Template:",
                                                                        " ",
                                                                        (_preview_template_templateName = preview.template.templateName) !== null && _preview_template_templateName !== void 0 ? _preview_template_templateName : "Default SafeSpeak payload"
                                                                    ]
                                                                }, void 0, true, {
                                                                    fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                                                                    lineNumber: 1194,
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "rounded-full px-2 py-1 text-[9px] font-bold uppercase tracking-[0.08em] ".concat(preview.missingRequiredInfo.length || preview.missingMappedFields.length || preview.missingConsentFlags.length ? "bg-[#fff2df] text-[#9a6a2e]" : "bg-[#e9f7ef] text-[#0b8b54]"),
                                                            children: preview.missingRequiredInfo.length || preview.missingMappedFields.length || preview.missingConsentFlags.length ? "Needs review" : "Ready preview"
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                                                            lineNumber: 1200,
                                                            columnNumber: 29
                                                ...
                                                preview.missingMappedFields.length ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "mt-2 text-[10px] leading-[1.55] text-[#9a5b12]",
                                                    children: [
                                                ...
                                                preview.missingConsentFlags.length ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "mt-1 text-[10px] leading-[1.55] text-[#9a5b12]",
                                                    children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("pre", {
                                                    className: "mt-3 max-h-[220px] overflow-auto rounded-[8px] bg-[#101827] p-3 text-[10px] leading-[1.5] text-[#dce8f8]",
                                                    children: stringifyPreviewPayload(preview.payload)
                                                }, void 0, false, {
                                                    fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                                                    lineNumber: 1228,
                                                    columnNumber: 27
                                        ...
                                        }, preview.destination.destinationId, true, {
                                            fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                                            lineNumber: 1185,
                                            columnNumber: 25
                                        }, this);
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            className: "pointer-events-none absolute bottom-[76px] left-[10px] top-[12px] w-px bg-[#d5deea]"
                        }, void 0, false, {
                            fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                            lineNumber: 1239,
                            columnNumber: 15
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: timelineEntries.map((entry)=>{
                                ...
                                const hasLongContent = Boolean(entry.label || entry.hint || entry.action);
                                const panelId = "timeline-panel-".concat(entry.id);
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("article", {
                                    ...
                                    children: [
                                        isExpanded ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "absolute -left-[2px] top-[8px] inline-flex h-[24px] w-[24px] items-center justify-center rounded-full bg-white shadow-[0_0_0_1px_#d7e1ee]",
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "h-[16px] w-[16px] rounded-full bg-[#0f52ba]"
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                                                lineNumber: 1252,
                                                columnNumber: 27
                                            ...
                                            className: "absolute left-[4px] top-[30px] h-[8px] w-[8px] rounded-full border border-[#cfd9e6] bg-[#dfe7f1]"
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                                            lineNumber: 1255,
                                            columnNumber: 25
                                        ...
                                        isExpanded ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            id: panelId,
                                            className: "relative flex flex-col justify-between overflow-hidden rounded-[18px] rounded-l-[20px] border border-l-[4px] border-[#dce5f1] border-l-[#0F52BA] bg-white px-6 pb-5 pt-4 shadow-[0_4px_10px_rgba(15,82,186,0.08)] ".concat(hasLongContent ? "min-h-[232px]" : "min-h-[104px]"),
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    className: "inline-flex h-5 items-center rounded-full bg-[#edf3ff] px-2 text-[9px] font-bold uppercase tracking-[0.08em] text-[#0f52ba]",
                                                                    children: entry.chip
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                                                                    lineNumber: 1265,
                                                        ...
                                                        entry.label ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                            className: "mt-3 text-[9px] font-semibold uppercase tracking-[0.06em] text-[#8fa0b8]",
                                                        ...
                                                        editingEntryId === entry.id ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                                                            onSubmit: (event)=>void handleInlineEditSubmit(event, entry.id),
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("textarea", {
                                                                    ...
                                                                    placeholder: "Update ".concat(entry.chip.toLowerCase(), " details")
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                                                                    lineNumber: 1295,
                                                                    columnNumber: 33
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                            ...
                                                                            children: isSavingTimeline ? "Saving..." : "Save"
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                                                                            lineNumber: 1322,
                                                                            columnNumber: 35
                                                            ...
                                                            className: "mt-1 text-[13px] font-semibold leading-[18px] text-[#1f2a3a]",
                                                        ...
                                                        entry.hint ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                            className: "mt-3 inline-flex items-center gap-1 text-[10px] font-semibold text-[#16a56a]",
                                                            children: [
                                                        ...
                                                        entry.isLocalOnly ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                            className: "mt-3 text-[10px] font-semibold text-[#9a5b12]",
                                                            children: "Stored locally only"
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                                                            lineNumber: 1343,
                                                            columnNumber: 31
                                                ...
                                                entry.action ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            className: "flex min-h-[72px] items-center justify-between rounded-[12px] border border-[#dce5f1] bg-white px-5 py-4 shadow-[0_2px_7px_rgba(15,23,42,0.03)]",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "min-w-0",
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                            className: "text-[9px] font-bold uppercase tracking-[0.08em] text-[#0f52ba]",
                                                            children: entry.chip
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                                                            lineNumber: 1365,
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                            className: "mt-1 truncate text-[13px] font-medium leading-[18px] text-[#253447]",
                                                            children: entry.value
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                                                            lineNumber: 1368,
                        ...
                        isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "mt-4 inline-flex items-center gap-2 rounded-[12px] border border-[#dce5f1] bg-white px-4 py-3 text-[11px] text-[#60728a]",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$tabler$2b$icons$2d$react$40$3$2e$35$2e$0_react$40$19$2e$2$2e$1$2f$node_modules$2f40$tabler$2f$icons$2d$react$2f$dist$2f$esm$2f$icons$2f$IconLoader2$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__IconLoader2$3e$__["IconLoader2"], {
                                    size: 14,
                                    className: "animate-spin"
                        ...
                        isManualEntryOpen ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                            onSubmit: handleManualEntrySubmit,
                            className: "mt-4 rounded-[12px] border border-[#dce5f1] bg-white p-4 shadow-[0_4px_10px_rgba(15,23,42,0.05)]",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-[10px] font-bold uppercase tracking-[0.08em] text-[#0f52ba]",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "mt-3 grid gap-3 sm:grid-cols-[132px_1fr]",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                            className: "flex flex-col gap-1",
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                    ...
                                                    onChange: (event)=>setManualEntryType(event.target.value),
                                                    className: "h-9 rounded-[8px] border border-[#dce5f1] bg-white px-2.5 text-[12px] font-semibold text-[#1f2a3a] outline-none",
                                                    children: manualEntryTypes.map((type)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                            value: type,
                                                            children: type
                                                        }, type, false, {
                                                            fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            children: isSavingTimeline ? "Saving..." : "Add Entry"
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                                            lineNumber: 1449,
                                            columnNumber: 21
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: "mr-2 inline-flex h-[16px] w-[16px] items-center justify-center rounded-full bg-[#ffe7c7] text-[#e79b2f]",
                        ...
                        !isLoading && timelineEntries.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "mt-4 rounded-[12px] border border-[#dce5f1] bg-white px-4 py-6 text-center text-[12px] text-[#60728a]",
                            children: "No backend timeline entries are available yet. Add a manual entry or go back to edit the report details."
                        }, void 0, false, {
                            fileName: "[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx",
                            lineNumber: 1471,
                            columnNumber: 17
...
_s(ReportSubmissionReviewPage, "a7DWYQvMs9adzOtMHc9wHQUXNSs=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchParams"]
    ];
});
_c = ReportSubmissionReviewPage;
;
var _c;
__turbopack_context__.k.register(_c, "ReportSubmissionReviewPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx [app-client] (ecmascript, next/dynamic entry)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/src/components/dashboard/dashboard-report-submission-pages/report-submission-review-page.tsx [app-client] (ecmascript)"));
}),
]);

//# sourceMappingURL=src_7b71e3d3._.js.map