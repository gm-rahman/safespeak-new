    ...
    translation: {
      ...
      dashboard: {
        ...
        notifications: {
          ...
          emptySubtitle:
            "Your report, support, and privacy updates will appear here.",
        ...
        settings: {
          ...
          termsIntro:
            "Please read these terms carefully before using SafeSpeak reporting, support, and AI-assisted tools.",
          privacyItems: {
    ...
    translation: {
      ...
      dashboard: {
        ...
        notifications: {
          ...
          emptySubtitle:
            "Tus actualizaciones de reportes, apoyo y privacidad apareceran aqui.",
        ...
        settings: {
          ...
          termsIntro:
            "Lee estos terminos atentamente antes de usar las herramientas de reportes, apoyo e IA de SafeSpeak.",
          privacyItems: {
      ...
      auth: {
        ...
        login: {
          ...
          resetSuccess:
            "Contrasena restablecida. Inicia sesion con tu nueva contrasena.",
          error: "Error al iniciar sesion.",
        },
        forgotPassword: {
          title: "Restablecer contrasena",
          description:
            "Ingresa tu correo y enviaremos un codigo de verificacion para restablecer tu contrasena.",
        ...
        resetPassword: {
          ...
          sessionExpired:
            "La sesion de restablecimiento expiro. Solicita un nuevo codigo.",
